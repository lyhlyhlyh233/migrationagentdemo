...
风险以原始发现、推荐策略和是否纳入工具范围区分，不用勾选代表技术问题已经解决。对话内提供方案与可跳过的风险入口，右侧风险抽屉 720px，管理页复用分类表格。表格集中展示风险/虚拟机、影响、策略及操作，规则依据和长说明按需展开。单条或成组选择后展开一处策略选择区，以带说明的单选项平铺呈现推荐、忽略约束、整改、本次不迁和自定义，不用下拉隐藏策略。宽管理页在表格右侧显示选择区，抽屉和窄屏在表格上方显示。输入框上方右侧统一放置深色继续阶段主按钮，避免挤占 Agent、模型和发送按钮。
